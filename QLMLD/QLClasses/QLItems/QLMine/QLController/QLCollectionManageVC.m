...
#import "QLCollectionManageVC.h"
#import "MJRefresh.h"
#import "UIScrollView+KS.h"
#import "QLCollectionDataModel.h"
@interface QLCollectionManageVC ()<UITableViewDelegate,UITableViewDataSource,KSRefreshViewDelegate>{
...
@implementation QLCollectionManageVC
...
- (void)tableHeadLoad{
    ...
    [QLHttpTool postWithBaseUrl:strBaseUrl Parameters:dicParam whenSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        array = [QLCollectionDataModel mj_objectArrayWithKeyValuesArray:responseObject[@"data"]];
...
- (void)refreshViewDidLoading:(id)view {
    if ([view isEqual:_tableMain.footerKS]) {
        ...
        [QLHttpTool postWithBaseUrl:strBaseUrl Parameters:dicParam whenSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
            if(self.dataSource){
                NSMutableArray *array = [QLCollectionDataModel mj_objectArrayWithKeyValuesArray:responseObject[@"data"]];
